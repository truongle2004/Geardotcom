        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl text-white">
            <Badge className="mb-4 bg-blue-600 hover:bg-blue-700">
              ...
              {featuredProducts[currentSlide].isBestSeller && !featuredProducts[currentSlide].isNew && "Best Seller"}
            </Badge>
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-200">
              Discover cutting-edge technology and premium gadgets for professionals and enthusiasts
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Find exactly what you need from our carefully curated selection of premium tech products
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category) => (
              <Card key={category.id} className="group cursor-pointer hover:shadow-2xl transition-all duration-300 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-xl text-gray-600">Hand-picked favorites from our tech experts</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {featuredProducts.map((product) => (
              <Card key={product.id} className="group cursor-pointer hover:shadow-2xl transition-all duration-300">
