...
interface Props {
  handleSetRightSidebarType: (type: SideBarTypeEnum) => void;
  onOpenChangeDialogLogout: (open: boolean) => void;
}

const LeftSideBar: FC<Props> = ({
  handleSetRightSidebarType,
  onOpenChangeDialogLogout
}) => {
  return (
      ...
      <CardContent className="p-6">
        ...
        <nav className="mt-8 space-y-2">
          <Button
            ...
            onClick={() =>
              handleSetRightSidebarType(SideBarTypeEnum.ACCOUNT_INFO)
            }
          >
          ...
          <Button
            variant="ghost"
            className="w-full justify-start text-left"
            onClick={() => handleSetRightSidebarType(SideBarTypeEnum.ADDRESS)}
          >
          ...
          <Button
            ...
            className="w-full justify-start text-left"
            onClick={() =>
              handleSetRightSidebarType(SideBarTypeEnum.MANAGE_ORDER)
            }
          >
          ...
          <Button
            ...
            className="w-full justify-start text-left"
            onClick={() =>
              handleSetRightSidebarType(SideBarTypeEnum.VIEW_HISTORY)
            }
          >
          ...
          <Button
            ...
            onClick={() => onOpenChangeDialogLogout(true)}
          >
